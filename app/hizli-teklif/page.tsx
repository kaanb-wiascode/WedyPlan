            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" placeholder="Elif Yılmaz" className="w-full px-4 py-3 rounded-xl border border-neutral-200 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500/20" required />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-neutral-700 mb-1">E-posta Adresiniz</label>
                  <input type="email" placeholder="elif@gmail.com" className="w-full px-4 py-3 rounded-xl border border-neutral-200 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500/20" required />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="tel" placeholder="0532 000 00 00" className="w-full px-4 py-3 rounded-xl border border-neutral-200 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500/20" required />
                </div>
                <div>
              ...
              <button type="submit" className="w-full py-4 text-sm font-semibold text-white bg-neutral-900 hover:bg-neutral-800 rounded-xl transition-all shadow-lg mt-4">
                Teklif İstiyorum & Hesabımı Oluştur →
              </button>
            </form>
          ) : (
            <div className="text-center py-10 space-y-4">
              <div className="w-12 h-16 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center mx-auto text-xl font-bold">✓</div>
              ...
              <div className="pt-4">
                <a href="/giris" className="px-6 py-3 bg-neutral-900 text-white rounded-full text-xs font-semibold inline-block">Çift Paneline Giriş Yap →</a>
              </div>
            </div>
          )}
        </div>
