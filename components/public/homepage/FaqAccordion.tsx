          ...
          return (
            ...
            >
              <button
                ...
                className="w-full p-6 text-left flex items-center justify-between gap-4 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E6007E]"
              >
                <span className="font-bold text-[16px] text-[#1D1D1F]">{faq.question}</span>
                <ChevronDown
                  className={`w-5 h-5 text-[#E6007E] shrink-0 transition-transform duration-300 ${
                    isOpen ? 'rotate-180' : ''
                  }`}
                />
              </button>
