  ...
  return (
    <section className="py-16 px-6 max-w-7xl mx-auto space-y-8">
      <div className="text-center space-y-2">
        <span className="text-[11px] font-bold text-[#0071e3] uppercase tracking-widest block">Adım Adım Süreç</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {HOW_IT_WORKS_STEPS.map((step) => (
          <div key={step.stepNumber} className="bg-white/50 backdrop-blur-2xl p-6 rounded-[28px] border border-white space-y-3">
            <span className="font-serif font-bold text-[36px] text-[#0071e3]/40 block">{step.stepNumber}</span>
