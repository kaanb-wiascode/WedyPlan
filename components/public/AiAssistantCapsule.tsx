...
export const AiAssistantCapsule: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Outer Glow Sheen */}
      <div className="absolute -inset-1 bg-gradient-to-r from-[#D4AF37]/30 via-[#E6007E]/30 to-purple-500/30 rounded-[32px] blur-xl opacity-50 animate-pulse" />
        ...
        <div className="flex-1 space-y-1 overflow-hidden">
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold tracking-wider text-[#1D1D1F] uppercase flex items-center gap-1.5">
              <Bot className="w-3.5 h-3.5 text-[#E6007E]" />
              WedyPlan Assist
            </span>
