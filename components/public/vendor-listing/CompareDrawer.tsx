    ...
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 max-w-3xl w-full px-4">
      <div className="bg-[#1D1D1F]/90 backdrop-blur-2xl border border-white/20 text-white p-4 rounded-[32px] shadow-2xl flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="p-2.5 bg-[#E6007E] rounded-2xl">
          ...
          {selectedVendors.map((v) => (
            <div key={v.id} className="relative group">
              ...
              <button
                ...
                className="absolute -top-1 -right-1 bg-rose-500 text-white rounded-full p-0.5 text-[8px] cursor-pointer"
              >
                <X className="w-3 h-3" />
              </button>
            </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="bg-[#E6007E] hover:bg-pink-600 text-white text-[12px] font-bold px-5 py-2.5 rounded-full transition shadow-md cursor-pointer flex items-center gap-1.5"
          >
