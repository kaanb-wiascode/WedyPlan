    ...
    <div className="bg-white/50 backdrop-blur-3xl border border-white/90 p-8 rounded-[36px] shadow-xs space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <h3 className="font-serif font-semibold text-[22px] text-[#1D1D1F]">Saatlik Müsaitlik Durumu</h3>
        </div>
        <span className="text-[11px] font-bold text-emerald-800 bg-emerald-50 px-3 py-1 rounded-full border border-emerald-200 flex items-center gap-1">
          <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600" /> Çakışmasız Takvim Aktif
        </span>
      </div>

      <p className="text-[13px] text-[#6E6E73]">
        Yaz 2026 Sezonu için Cumartesi / Pazar gece vardiyalarında son 4 boş tarih kalmıştır.
      </p>
